...
public class Pack extends Delivery {
    ...
    public Pack(String numGuide, double weight, boolean isFragile, String content, double value, Client sender, Client addressee, ArrayList<Status> status) {
    ...
    public Pack(double weight, boolean isFragile, String content, double value, Client sender, Client addressee, ArrayList<Status> status) {
